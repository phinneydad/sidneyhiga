...
description: Extract insights using a lambda architecture.
author: <ercenk>
ms.author: <ercenk>
manager: <gmarchet>
...
![Factory to dashboard.](assets/extracting-from-insights-iot/factory-to-dashboard.png)
...
![Things to Insights to Actions.](assets/extracting-from-insights-iot/things-insights-actions.png)
...
![Architecture of the solution.](assets/extracting-from-insights-iot/architecture.png)
...
![Data fow: source to ingestion to presentation to action.](assets/extracting-from-insights-iot/data-flow.png)
...
![Data shape from hierarchical to flat.](assets/extracting-from-insights-iot/hierarchy-to-flat.png)
...
![Https polled for data and processed by Functions.](assets/extracting-from-insights-iot/poll-logic-process.png)
...
(assets/extracting-from-insights-iot/lambda-schematic.png)
...
![Lambda architecture.](assets/extracting-from-insights-iot/lambda-architecture-all.png)
...
![Lambda architecture: speed layer highlighted.](assets/extracting-from-insights-iot/lambda-2.png)
...
![Event Hubs to analysis to Power BI.](assets/extracting-from-insights-iot/event-hubs-to-power-bi.png)
...
![Lambda architecture: batch layer highlighted.](assets/extracting-from-insights-iot/lambda-3.png)
...
![Lambda architecture: batch layer highlighted.](assets/extracting-from-insights-iot/master-data-to-ml-analytics.png)
...
![Lambda architecture: analytics clients layer highlighted.](assets/extracting-from-insights-iot/lambda-4.png)
...
![Lambda architecture: batch layer highlighted.](assets/extracting-from-insights-iot/client-screen.png)
