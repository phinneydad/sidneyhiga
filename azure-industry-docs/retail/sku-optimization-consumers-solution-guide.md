...
![sku-max-model.png](assets/sku-optimization-assets/sku-max-model.png)
    <center><font size="1">_Figure 1: example of SKU performance report—courtesy of Neal Analytics_</font></center>
...
<center><img style="float: center;" src="assets/sku-optimization-assets/assortment-optimization-problem.PNG" width="200"/></center>
...
<center><img style="float: center;" src="assets/sku-optimization-assets/matrix-construction.PNG" width="300"/></center>
...
![architecture-skue-optimization.png](assets/sku-optimization-assets/architecture-skue-optimization.png)<center><font size="1">_Figure 2: architecture for SKU optimization—courtesy of Neal Analytics_</font></center>
...
<center><img src="assets/sku-optimization-assets/azure-data-factory.png" height= "70" width= "600"></center><center><font size="1"><i>Figure 3: Basic concepts of an Azure Data Factory</i></font></center>
...
![ml-training-pipeline-example.png](assets/sku-optimization-assets/ml-training-pipeline-example.png)<center><font size="1">_Figure 4: example of ML training pipeline with R and pre-built components_</font></center>
...
![data-factory-pipeline-databricks.png](assets/sku-optimization-assets/data-factory-pipeline-databricks.png)<center><font size="1">_Figure 5: example of Data Factory pipeline with Databricks notebook activity_</font></center>
...
![ml-server-deployment-example.png](assets/sku-optimization-assets/ml-server-deployment-example.png)<center><font size="1">_Figure 6: example of ML server deployment_</font></center>
...
![sku-max-model.png](assets/sku-optimization-assets/sku-max-model.png)<center><font size="1">_Figure 7: example of model results report—courtesy of Neal Analytics_</font></center>
